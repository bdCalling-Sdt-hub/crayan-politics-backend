    ...
    const filterFilter = (req, file, cb) => {
        if (file.fieldname === 'image') {
            if (file.mimetype === 'image/jpeg' ||
                ...
                throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Only .jpeg, .png, .jpg file supported');
            }
        }
            ...
            if (file.mimetype === 'video/mp4' || file.mimetype === 'audio/mpeg') {
                ...
                throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Only .mp4, .mp3, file supported');
            }
        }
            ...
            if (file.mimetype === 'application/pdf') {
                ...
                throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Only pdf supported');
            }
        }
        else {
