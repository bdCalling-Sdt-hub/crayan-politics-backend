...
router.post('/change-password', (0, auth_1.default)(user_1.USER_ROLES.ADMIN), (0, validateRequest_1.default)(auth_validation_1.AuthValidation.createChangePasswordZodSchema), auth_controller_1.AuthController.changePassword);
